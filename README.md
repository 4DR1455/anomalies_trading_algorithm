...
<u><i>Note:</u></i> There is a known bug affecting lab data reporting: occasionally, the dashboard displays large, non-existent crashes. If in doubt, ask me for the Alpaca data or verify consistency with the production dashboard.
